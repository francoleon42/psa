...
Bienvenidos a la pagina oficial de la **Parroquia San Antonio de Padua**. Aquí encontrarás todos los avisos, horarios de misa, novedades y actividades de nuestra comunidad. Te invitamos a estar al tanto de todas nuestras noticias y a participar en las actividades que tenemos preparadas para ti y tu familia.
